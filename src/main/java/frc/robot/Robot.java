...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    a.configForwardLimitSwitchSource(LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.NormallyOpen);
    a.getSensorCollection().isFwdLimitSwitchClosed();
  }
  ...
  public void teleopPeriodic() {
    if(a.getSensorCollection().isRevLimitSwitchClosed()){
